...
export default function HowTo({ props, lang }) {
  return (
    <section className="my-16">
      <div className="flex justify-between items-center main__layout mb-4">
        <h2 className="text-2xl uppercase font-bold lg:text-4xl">How-to</h2>
        <Link href="/how-to" className="text-[#ACACAC]">view all</Link>
      </div>
